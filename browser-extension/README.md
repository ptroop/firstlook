# First Look review-first form-fill helper

This optional Chrome/Edge Manifest V3 extension reduces repeated typing on public job application forms.
...
- It fills supported name, email, phone, city and LinkedIn fields.
...
6. Open the extension, save your contact profile once, then click **Fill current page**.
...
The extension is intentionally separate from the website's CV text. Do not put passwords, government IDs, sensitive demographic information or application answers into this profile.
